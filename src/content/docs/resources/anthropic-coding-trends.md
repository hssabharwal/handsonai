...
This report provides context for the [Coding](../../use-cases/coding/) use case primitive and the [Agents](../../agentic-building-blocks/agents/) building block. The multi-agent and orchestrator-workers trends connect directly to the playbook's [workflow architecture patterns](../../patterns/workflow-architecture/), particularly [Orchestrator-Workers](../../patterns/workflow-architecture/orchestrator-workers/) and [Autonomous Agents](../../patterns/workflow-architecture/autonomous-agents/).

## Access

[↓ Download PDF](/assets/pdfs/anthropic-coding-trends-2026.pdf)

[View original ](https://resources.anthropic.com/hubfs/2026%20Agentic%20Coding%20Trends%20Report.pdf)
