...
This guide is the primary reference for the [Skills](../../agentic-building-blocks/skills/) building block and directly informs the playbook's [Agents & Skills](../../use-the-playbook/build/) section. The skill structure and progressive disclosure concepts appear throughout the playbook's plugin development guides.

## Access

[↓ Download PDF](/assets/pdfs/anthropic-skills-guide.pdf)

[View original ](https://claude.com/blog/complete-guide-to-building-skills-for-claude)
