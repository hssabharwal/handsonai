...
| M365 Copilot | ✅ Native | Cowork reads `SKILL.md` files from OneDrive (`Documents/Cowork/Skills/`) — Frontier preview |
...
The Build skill (Step 4) also has reference files that it uses. On platforms with native skill support (Claude, Cursor, Codex CLI, Gemini CLI), these are included automatically. M365 Copilot Cowork's documented format only describes a single `SKILL.md` per skill folder, so until Microsoft documents reference-file support you'll need to paste the [references/agent-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/agent-spec.md) and [references/skill-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/skill-spec.md) contents into the body of `SKILL.md` after the main instructions. On paste-based platforms (ChatGPT Projects, Gems), copy and paste the [references/agent-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/agent-spec.md) and [references/skill-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/skill-spec.md) files after the SKILL.md content when you set up Build.
:::
