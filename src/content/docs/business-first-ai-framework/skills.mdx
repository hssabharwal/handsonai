---
title: Set Up the Business-First AI Framework Skills
description: Step-by-step setup instructions for the seven Business-First AI Framework skills on Claude, ChatGPT, Gemini, M365 Copilot, Cursor, Codex, and more
---
...
| Platform | Skill Support | How It Works |
|----------|:------------:|--------------|
| Claude Chat (claude.ai) | ✅ Native | Upload skill files in Settings |
| Claude Cowork (Desktop App) | ✅ Native | Built-in plugin directory |
| Claude Code (Desktop App) | ✅ Native | Plugin install via Code tab in desktop app |
| Claude Code (Terminal) | ✅ Native | Plugin install via command line |
| ChatGPT | 🟡 Beta | Native skills on some plans; **Projects** workaround for all paid plans |
| Google Gemini (app) | 🟠 Workaround | No native skills; use **Gems** to get the same result |
| M365 Copilot | 🟠 Workaround | No native skills; use **Notebooks** to get the same result |
| Cursor | ✅ Native | Reads skill files from your project folder |
| OpenAI Codex | ✅ Native | Reads skill files from your project folder (CLI, desktop app, and IDE extension) |
| Gemini CLI / Antigravity | ✅ Native | Reads skill files from your project folder |

**Legend:** ✅ Native = your platform officially supports Agent Skills. 🟡 Beta = native support exists but is limited. 🟠 Workaround = instructions use your platform's closest equivalent feature.
...
**Step 2 — Download the skill files from GitHub**

1. Open [this page](https://github.com/jamesgray-ai/handsonai-plugins) in your web browser — this is where the skill files are stored
2. Look for the green button that says **Code** — click it
3. Click **Download ZIP** in the dropdown menu
4. A file called `handsonai-plugins-main.zip` will download to your computer (it usually goes to your **Downloads** folder)

**Step 3 — Extract (unzip) the file**

1. Open your **Downloads** folder and find the file `handsonai-plugins-main.zip`
2. **Double-click** it — this creates a new folder called `handsonai-plugins-main`
3. Open that folder

**Step 4 — Find the skill folders**

Inside the extracted folder, click through these folders in order:

`plugins` → `business-first-ai` → `skills`

You'll see a list of folders — one for each skill: `analyze`, `build`, `deconstruct`, `design`, `improve`, `run`, `test`.

**Step 5 — Create a ZIP for your first skill**

Start with the `analyze` folder (Step 1 of the framework).

- **Mac:** Right-click on the `analyze` folder and choose **Compress "analyze"**. A file called `analyze.zip` appears next to the folder.
- **Windows:** Right-click on the `analyze` folder, choose **Send to** → **Compressed (zipped) folder**. A file called `analyze.zip` appears.

:::caution[Common mistake]
Zip the **folder itself** — not the individual files inside it. When you open the ZIP, you should see a single folder named `analyze`, not loose files.
:::

**Step 6 — Upload the skill to Claude**
...
4. Select the `analyze.zip` file you just created

**Step 7 — Turn the skill on**
...
**Step 9 — Add more skills as you need them**

Go back to Step 5 and repeat for `deconstruct` (the next skill in the framework). Add the remaining skills (design, build, test, run, improve) later as you progress.
...
Plugins don't update automatically. To get the latest skills, go back to **Customize** → **Browse plugins** → **Personal** tab, click the **...** menu next to **handsonai-plugins**, and choose **Check for updates**.
:::
...
ChatGPT is rolling out native skill support using the same SKILL.md format. If your plan supports it (currently Enterprise, Edu, and some Team/Business plans — admins may need to enable it), you can create and install skills directly in ChatGPT without using Projects.

See OpenAI's official guide: [Skills in ChatGPT](https://help.openai.com/en/articles/20001066-skills-in-chatgpt)

If you don't see a Skills option in your ChatGPT settings, use the **Projects** approach below — it works on all paid plans and gives you the same result.

#### Using ChatGPT Projects (works on all paid plans)
...
When a skill says it will "save output to a file," ChatGPT will show the output directly in the chat instead. Copy and save it yourself if you want to keep it.
:::
...
<details>
<summary><strong>M365 Copilot</strong> — 🟠 Workaround using Notebooks</summary>

M365 Copilot does not natively support Agent Skills yet. These instructions use **Notebooks** — Copilot's persistent instruction containers — to achieve the same result. You paste the skill's instructions into a Notebook, and Copilot follows them.

**Official docs:** [Provide Custom Instructions for Copilot Notebooks](https://support.microsoft.com/en-us/topic/provide-custom-instructions-for-your-microsoft-365-copilot-notebook-763a9536-d459-4f90-8835-c411863d91ce)

**What you need first:** An M365 Copilot license (included with Microsoft 365 Business Premium, E3, or E5 with the Copilot add-on).
...
1. Open [copilot.microsoft.com](https://copilot.microsoft.com) in your browser
2. Click **New Notebook** to create a fresh workspace

**Step 5 — Add the instructions**

1. Look for the expand button (an arrow or ↕ icon) next to the notebook name at the top
2. Click it to reveal the custom instructions area
3. Paste the text you copied:
   - **Mac:** Press **Cmd+V**
   - **Windows:** Press **Ctrl+V**
...
The instructions now apply to everything you type in this Notebook. Type:

> Help me analyze where AI fits in my work

Copilot will follow the skill's structured process.

**Step 7 — Add more Notebooks later**

Repeat these steps for **Deconstruct** (Step 2). Create additional Notebooks as you progress.

:::tip[About file saving]
When a skill says it will "save output to a file," Copilot will show the output in the chat instead. Copy and save it yourself.
:::
...
Type `/business-first-ai:analyze` and press **Enter**. The Analyze skill should start running and begin asking you questions. You can also just type *"Help me analyze AI workflow opportunities"* and Claude will activate the right skill automatically.
...
**What you need first:** Cursor installed and a project folder open. Your **project root** is the top-level folder you have open in Cursor — this is where Cursor looks for skills.

**Step 1 — Download the skill files from GitHub**

1. Open [this page](https://github.com/jamesgray-ai/handsonai-plugins) in your web browser
2. Click the green **Code** button, then click **Download ZIP**
3. A file called `handsonai-plugins-main.zip` downloads to your computer (usually to your **Downloads** folder)

**Step 2 — Extract (unzip) the file**

1. Find the downloaded ZIP file in your Downloads folder
2. **Double-click** it — this creates a folder called `handsonai-plugins-main`

**Step 3 — Find the skill folders**

Open the extracted folder and click through: `plugins` → `business-first-ai` → `skills`. You'll see folders for each skill (`analyze`, `deconstruct`, etc.).

**Step 4 — Create the skills directory in your project**
...
Copy the skill folders you want (start with `analyze` and `deconstruct`) from Step 3 into the `.agents/skills/` folder you just created.
...
1. Open [this page](https://github.com/jamesgray-ai/handsonai-plugins) in your web browser
2. Click the green **Code** button, then click **Download ZIP**
3. A file downloads to your computer (usually to your **Downloads** folder)

**Step 2 — Extract (unzip) the file**

Double-click the downloaded ZIP file — this creates a folder called `handsonai-plugins-main`.

**Step 3 — Find the skill folders**

Open the extracted folder and click through: `plugins` → `business-first-ai` → `skills`.
...
Copy the skill folders you want (start with `analyze` and `deconstruct`) from Step 3 into `.agents/skills/` in your project.
...
**What you need first:** Gemini CLI or Antigravity installed. Your **project root** is the top-level folder you're working in — the folder open in Antigravity or that you navigated to in your terminal.
...
Copy the skill folders you want (start with `analyze` and `deconstruct`) from Step 3 into `.gemini/skills/` (or `.agents/skills/`) in your project.
...
These are the direct links to each skill's instruction file on GitHub. Used by the ChatGPT, Gemini, and M365 Copilot setup instructions above — and useful for any platform where you need to copy the skill text.
...
| Step | Skill | File |
|:----:|-------|------|
| 1 | Analyze | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/analyze/SKILL.md) |
| 2 | Deconstruct | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/deconstruct/SKILL.md) |
| 3 | Design | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/design/SKILL.md) |
| 4 | Build | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/SKILL.md) |
| 5 | Test | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/test/SKILL.md) |
| 6 | Run | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/run/SKILL.md) |
| 7 | Improve | [SKILL.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/improve/SKILL.md) |

:::note[About the Build skill]
The Build skill (Step 4) also has reference files that it uses. On platforms with native skill support (Claude, Cursor, Codex CLI, Gemini CLI), these are included automatically. On paste-based platforms (ChatGPT Projects, Gems, Notebooks), copy and paste the [references/agent-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/agent-spec.md) and [references/skill-spec.md](https://github.com/jamesgray-ai/handsonai-plugins/blob/main/plugins/business-first-ai/skills/build/references/skill-spec.md) files after the SKILL.md content when you set up Build.
:::
...
| **Claude Code (Desktop App)** | Type `/business-first-ai:analyze` in the Code tab, or describe your need. Same commands as the terminal. |
| **Claude Code (Terminal)** | Type `/business-first-ai:analyze` (or any slash command below). Or just describe your need — Claude picks the skill. |
...
| **M365 Copilot** | Open the **Notebook**. Type your request. |
...
You can also invoke skills directly with slash commands like `/business-first-ai:analyze`. See the table above.
:::
