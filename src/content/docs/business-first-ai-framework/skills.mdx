...
Click the link below to download the **Analyze** skill (Step 1 of the framework):

> [**Download analyze.zip**](https://github.com/jamesgray-ai/handsonai-plugins/releases/latest/download/analyze.zip)

The file downloads to your computer (usually to your **Downloads** folder).
...
Go back to Step 2 and repeat with the download link for the next skill you need:
