...
The [Builder Tools Setup](../../builder-setup/) guide walks you through everything you need — an AI code editor ([Step 2](../../builder-setup/editor-setup/)), Git ([Step 3](../../builder-setup/git-install/)), GitHub ([Step 4](../../builder-setup/github-setup/)), and the AI Registry ([Step 6](../../builder-setup/notion-registry-setup/)). If you haven't set these up yet, that guide has you covered.
:::
## What This Produces
...
This step is facilitated by the **`build`** Business-First AI Framework skill. See [Set Up the Skills](../skills/) for installation instructions across all supported platforms.
