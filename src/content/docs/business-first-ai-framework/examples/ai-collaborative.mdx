...
<Tabs>
  <TabItem label="Any AI Tool (Portable)">
...
- [Deterministic Automation Workflow Example](../deterministic-automation/) — when AI follows fixed rules with no judgment needed
- [Autonomous Agent Workflow Example](../autonomous-agent/) — when AI executes end-to-end with minimal supervision
- [Research Use Cases](../../../use-cases/research/) — more examples of AI-powered research workflows like meeting prep
- [Ideation & Strategy Use Cases](../../../use-cases/ideation-and-strategy/) — collaborative brainstorming and planning with AI
- [Analyze AI Workflow Opportunities](../../analyze/) — identify which workflows are candidates for AI collaboration
- [Deconstruct Workflows](../../deconstruct/) — break down workflows into AI-ready steps
