...
- [AI Collaborative Workflow Example](../ai-collaborative/) — when AI and human iterate together
- [Content Creation Use Cases](../../../use-cases/content-creation/) — more examples of AI-powered content workflows
- [Research Use Cases](../../../use-cases/research/) — more examples of AI-powered research workflows
- [Automation Use Cases](../../../use-cases/automation/) — turning multi-agent pipelines into scheduled operations
- [Analyze AI Workflow Opportunities](../../analyze/) — identify which workflows are candidates for autonomous agents
- [Deconstruct Workflows](../../deconstruct/) — break down workflows into agent-ready steps
- [Plugin Marketplace](../../../use-the-playbook/build/) — browse all agents and skills used in this pipeline
