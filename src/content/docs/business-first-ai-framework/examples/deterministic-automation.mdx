...
- [AI Collaborative Workflow Example](../ai-collaborative/) — when AI needs to research, reason, and iterate with a human
...
- [Automation Use Cases](../../../use-cases/automation/) — turning deterministic workflows into scheduled pipelines
- [Analyze AI Workflow Opportunities](../../analyze/) — identify which of your workflows are candidates for automation
- [Deconstruct Workflows](../../deconstruct/) — break down complex workflows into automatable steps
