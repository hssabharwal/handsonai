...
**Coach pages retired.** The "Use AI as Your Coach" pages have been removed. The [MCP server](../../mcp-server/) and [Business-First AI plugin](../../business-first-ai-framework/skills/) now provide better guided experiences — the framework overview page links directly to them.

These changes are live across all [Build documentation](../../business-first-ai-framework/build/), the `framework-orchestrator` agent, and the `building-workflows` skill (Business-First AI plugin v5.0.1).
