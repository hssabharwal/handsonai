...
The [Business-First AI Framework](../../business-first-ai-framework/) guides you through that entire journey:

1. **[Analyze](../../business-first-ai-framework/analyze/)** — Run a structured audit of your workflows to identify where AI creates the most value
2. **[Deconstruct](../../business-first-ai-framework/deconstruct/)** — Break those workflows into discrete steps and map each one to AI building blocks
3. **[Build](../../business-first-ai-framework/build/)** — Turn that analysis into a working AI workflow, ready for production
...
- **[Model](../../agentic-building-blocks/models/)** — The AI engine that powers everything
- **[Prompt](../../agentic-building-blocks/prompts/)** — Instructions you give the AI
- **[Context](../../agentic-building-blocks/context/)** — Background knowledge the AI needs (your data, your docs, your domain)
- **[Project](../../agentic-building-blocks/projects/)** — A persistent workspace that holds everything together
- **[Memory](../../agentic-building-blocks/memory/)** — Accumulated knowledge the AI retains across conversations
- **[Skill](../../agentic-building-blocks/skills/)** — A reusable routine the AI can invoke on demand
- **[Agent](../../agentic-building-blocks/agents/)** — An autonomous AI that plans and executes multi-step work
- **[MCP](../../agentic-building-blocks/mcp/)** — A connector that lets AI access external tools and data
- **[API](../../agentic-building-blocks/api/)** — Programmatic interface for calling AI from code
- **[SDK](../../agentic-building-blocks/sdk/)** — Frameworks for building AI workflows and agent systems
- **[CLI](../../agentic-building-blocks/cli/)** — Terminal-native interface for interacting with AI

These are platform-agnostic concepts. The playbook maps each block across Claude, ChatGPT, Gemini, and M365 Copilot in a single [comparison table](../../agentic-building-blocks/). So instead of learning four different systems, you learn the blocks once and apply them everywhere.
...
**Start here:** Head to [Analyze Workflows](../../business-first-ai-framework/analyze/) and run the audit. In 20 minutes, you'll have a prioritized list of AI opportunities.

Or jump to what interests you:

- [Business-First AI Framework](../../business-first-ai-framework/)
- [Use Cases](../../use-cases/)
- [Agentic Building Blocks](../../agentic-building-blocks/)
- [Plugin Marketplace](../../use-the-playbook/build/)
- [Builder Tools Setup Guide](../../builder-setup/)
