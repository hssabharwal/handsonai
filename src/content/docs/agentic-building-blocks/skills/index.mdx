...
[→ Full Cowork plugin guide](../../use-the-playbook/build/using-plugins.md#using-plugins-in-claude-cowork)
  </TabItem>
...
[→ Full Claude Code plugin guide](../../use-the-playbook/build/using-plugins.md#getting-started-in-claude-code)
  </TabItem>
...
[→ Detailed ZIP upload walkthrough](../../use-the-playbook/build/using-plugins.md#using-skills-in-claudeai-web)
  </TabItem>
