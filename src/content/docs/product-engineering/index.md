...
description: Product management and software engineering concepts for non-technical leaders and AI builders — understand how software gets planned, built, and shipped
date: 2026-02-16
author: James Gray
...
|------|------------------|
| [Product Requirements](requirements/) | PRDs — the document that aligns a team on what to build before they start |
| [User Stories & Acceptance Criteria](user-stories/) | The building blocks of requirements — how to describe what users need and define "done" |
| [Roadmaps & Prioritization](roadmapping/) | Deciding what to build first — frameworks for making trade-offs |
| [Stakeholder Management](stakeholder-management/) | The people side — communication, buy-in, and managing expectations |

### Engineering

| Page | What You'll Learn |
|------|------------------|
| [Software Development Lifecycle](sdlc/) | How software gets built — the plan-build-test-ship cycle, Agile vs. Waterfall, sprints, and key roles |
| [Project Tracking with GitHub](tracking/) | Issues, epics, projects, and pull requests — the tools teams use to organize work |
| [Architecture Decision Records](architecture-decisions/) | Recording significant technical decisions and their rationale |
| [Context Engineering](../ai-engineering/context-engineering/) | Designing everything an AI model sees — system prompts, tools, memory, and state |
| [Evaluation](../ai-engineering/evaluation/) | Measuring whether AI systems produce good outputs — approaches, metrics, and eval suites |
