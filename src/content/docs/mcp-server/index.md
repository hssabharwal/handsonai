...
![Hands-on AI Playbook MCP connector enabled in Claude showing available connectors list](/assets/images/claude-mcp-connector-hands-on-ai-cookbook.png)
...
![Claude permission prompt asking to allow Search playbook from Hands-on AI Playbook](/assets/images/claude-mcp-tool-permission-prompt-hands-on-ai-cookbook.png)
...
![Claude Settings showing per-tool permissions for the Hands-on AI Playbook MCP connector](/assets/images/claude-mcp-tool-permissions-settings-hands-on-ai-cookbook.png)
