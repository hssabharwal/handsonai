...
Start at the [Set Up the Skills](/business-first-ai-framework/skills/) page for step-by-step setup instructions for your specific platform — Claude Chat, Cowork, Code, ChatGPT, Gemini, and M365 Copilot. This page covers advanced plugin management for the Claude ecosystem.
:::
...
**Review the source:** All plugin files are open source in the [handsonai-plugins GitHub repository](https://github.com/jamesgray-ai/handsonai-plugins/tree/main/plugins). Each plugin's detail page (linked from the [marketplace](../)) includes the full list of agents and skills with descriptions of what they do.
...
:::note
Skills from the `ai-registry` plugin require the [Notion MCP connector](../../../builder-setup/notion-registry-setup/) to be configured. Without it, Claude can follow the naming conventions and draft the output, but cannot read from or write to Notion.
:::
...
Every file is plain-text Markdown — no compiled code, no special format. You don't need Claude Code or plugins to use them. Download skill folders from GitHub and place them in your platform's skill directory. See [How to Add Skills to Your Platform](../../../agentic-building-blocks/skills/#how-to-add-skills-to-your-platform) for step-by-step instructions for Claude Code, Cursor, Codex CLI, Gemini CLI, and VS Code Copilot.
...
- [Notion Registry setup](../../../builder-setup/notion-registry-setup/) — required for `ai-registry` skills that save to Notion
