...
---A growing collection of ready-to-use **agents**, **skills**, and **prompts** that give your AI tool domain expertise it doesn't have out of the box. These are plain-text Markdown files — download from [GitHub](https://github.com/jamesgray-ai/handsonai-plugins/tree/main/plugins) and add to any AI tool, or install as Claude Code plugins. See [Using Plugins](using-plugins/) for setup details.

---

## 🚀 Business-First AI Framework

The [Business-First AI Framework](../../business-first-ai-framework/) as executable skills. A seven-step methodology: Analyze, Deconstruct, Design, Build, Test, Run, Improve. 1 agent, 7 skills.

[→ Business-First AI Framework](../../business-first-ai-framework/skills/)
...
[→ Agentic Coding](../../use-cases/coding/agentic-coding/)
