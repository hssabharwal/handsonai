...
|------|----------------|-------------|
| [Claude Code](../../../platforms/claude/getting-started/) | AI coding agent that runs the workflow | `claude --version` |
| [Git](../../../builder-setup/git-install/) | Version control for commits, branches, and worktrees | `git --version` |
