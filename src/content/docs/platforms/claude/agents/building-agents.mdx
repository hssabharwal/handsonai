...
Your [Design phase](../../../../business-first-ai-framework/design/) produced a platform-agnostic agent blueprint. Here's how each component maps to a Claude Code agent file:
...
Your [Design phase](../../../../business-first-ai-framework/design/) produced a platform-agnostic agent blueprint. Here's how each component maps to the Agent SDK:
...
- [Scheduling Subagents](../../subagents/scheduling-subagents/) — run agents automatically on a schedule
