...
- Claude Code installed and authenticated (see [Getting Started with Claude](../../getting-started/#3-install-claude-code))
...
For more detailed troubleshooting, see [Scheduled Subagent Troubleshooting](../scheduling-subagent-issues/).
