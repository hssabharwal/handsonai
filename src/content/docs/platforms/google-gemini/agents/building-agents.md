...
---> **Part of:** [Build Workflows > Agents](../../../../business-first-ai-framework/build/)
...
- [Agents overview](../../../../business-first-ai-framework/build/) — the platform-agnostic agent decision framework
- [Design Your AI Workflow](../../../../business-first-ai-framework/design/) — produce the agent blueprint that feeds into these implementations
