...
- **M365 Copilot** - AI assistant in Microsoft 365 apps
- **Azure OpenAI** - Enterprise OpenAI deployment
- **Copilot Studio** - Custom copilot builder
- **Microsoft Graph** - Data integration
- **Semantic Index** - Enterprise search

## Resources

- [M365 Copilot Documentation](https://learn.microsoft.com/en-us/microsoft-365-copilot/)
