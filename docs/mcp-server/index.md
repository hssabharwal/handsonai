...
![Hands-on AI Playbook MCP connector enabled in Claude showing available connectors list](../assets/images/claude-mcp-connector-hands-on-ai-cookbook.png){ width="600" }
...
![Claude permission prompt asking to allow Search playbook from Hands-on AI Playbook](../assets/images/claude-mcp-tool-permission-prompt-hands-on-ai-cookbook.png){ width="600" }
...
![Claude Settings showing per-tool permissions for the Hands-on AI Playbook MCP connector](../assets/images/claude-mcp-tool-permissions-settings-hands-on-ai-cookbook.png){ width="600" }
...
!!! info "No personally identifiable information is collected"
    ...
    **Why:** We use this aggregate data to understand which topics people search for most and where content gaps exist, so we can create new pages and improve existing ones. The goal is to make the playbook more useful for everyone.

    **Retention:** Analytics data is retained for 12 months, then deleted.

    **Storage:** Data is stored in a private database accessible only to the playbook maintainer. It is never shared, sold, or used for advertising.
