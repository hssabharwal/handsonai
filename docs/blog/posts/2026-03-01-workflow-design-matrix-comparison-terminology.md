...
This affects the [Analyze](../../business-first-ai-framework/analyze.md), [Design](../../business-first-ai-framework/build/design.md), and [Build](../../business-first-ai-framework/build/index.md) pages, all three worked examples, and the Business-First AI plugin (now v5.0.0).
