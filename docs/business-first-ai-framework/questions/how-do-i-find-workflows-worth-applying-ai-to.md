...
To run the audit, use the [Analyze AI Workflow Opportunities](../analyze.md) — a meta prompt that guides an AI through a structured process: scanning what it already knows about your work, interviewing you to fill gaps, then producing a categorized report with specific opportunities and actionable first steps.
