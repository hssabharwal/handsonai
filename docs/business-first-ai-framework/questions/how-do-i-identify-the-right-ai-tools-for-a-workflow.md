...
You can't choose the right AI tools for a workflow you don't fully understand. The [Business-First AI Framework](../index.md) addresses this with a structured approach: discover opportunities first, then deconstruct workflows into building blocks before selecting tools.
...
- Map each step to one or more of the AI building blocks: Model, Prompt, Context, Skill, Agent, MCP, Project, Memory, API, or SDK
