...
|---------|----------|---------|
| Agentic Building Blocks | `agentic-building-blocks/` | The AI building blocks (Model, Prompts, Context, Projects, Skills, Agents, MCP, Memory, API, SDK) |
| Business-First AI Framework | `business-first-ai-framework/` | Three-phase methodology (Analyze, Deconstruct, Build) |
